...
html_area_Map = {
  ...
  '重庆市': ['万州区', '黔江区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县'],
  ...
  '中山市': ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '中山港街道', '黄圃镇', '南头镇', '东凤镇', '阜沙镇', '小榄镇', '古镇镇', '横栏镇', '三角镇', '民众镇', '南朗镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇'],
  '潮州市': ['湘桥区', '潮安区', '饶平县'],
  ...
  '三亚市': ['海棠区', '吉阳区', '天涯区', '崖州区'],
  '三沙市': ['西沙区', '南沙区'],
  '儋州市': ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '三都镇', '王五镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇', '洋浦经济开发区'],
...
municipality_city = ['北京市', '天津市', '上海市', '重庆市']

not_municipality_city = [city for city in html_area_Map.keys() if city not in municipality_city]
